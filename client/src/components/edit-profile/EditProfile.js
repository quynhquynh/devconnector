...
class EditProfile extends Component {
    ...
    componentWillReceiveProps(nextProps){
        ...
        if(nextProps.profile.profile){
            ...
            let { handle, company, website, location, status, skills, githubusername, bio, social } = profile
            const skillsCSV = skills.join(',') 
            let { twitter, facebook, linkedin, youtube, instagram } = social !== undefined ? social : ''
            ...
            this.setState({ handle, company, website, location, status, skills: skillsCSV, githubusername, bio, social, twitter, facebook, linkedin, youtube, instagram})
        }
    }
    ...
    render() {
        ...
        const { displaySocialInputs, handle, company, website, location, status, skills, githubusername, bio, twitter, facebook, linkedin, youtube, instagram, errors } = this.state
        const options = [
